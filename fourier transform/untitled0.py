...
sigx = 100e-3/ody #53e-3/odx  # pixel
sigy = 30e-3/ody #10e-3/ody  # pixel
...
s = 5000 # external interation number
f = 110 # focal length
l = 895e-6 # lambda
factor = f*l
...
for t in range(s):
    ...
    #cost, DOE_tf, learning_rate, optimizer_string = costfunction(DOE, target, initial_profile, Nx, Ny,t,learning_rate, costType,squaredDifferences, targetphase, rg)
    #DOE = DOE_tf.numpy() 
